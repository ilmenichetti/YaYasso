...
#'
#' @param t TO BE DONE
#' @param ksY TO BE DONE
#' @param pY TO BE DONE
#' @param beta1  TO BE DONE
#' @param beta2  TO BE DONE
#' @param gammma  TO BE DONE
#' @param delta1  TO BE DONE
#' @param delta2  TO BE DONE
#' @param r  TO BE DONE
#' @param C0  TO BE DONE
#' @param In  TO BE DONE
#' @param AWEN  TO BE DONE
#' @param xi  TO BE DONE
#' @param MT MeanTemperature
#' @param TA  TemperatureAmplitude = (mothly temp. range)/2
#' @param PR_mm, Precipitation_mm
